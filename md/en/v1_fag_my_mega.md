...
A. Rewards are provided digitally (e.g., PayPal). Winners will receive an e-mail with instructions on how to claim them.  
No purchase is ever required to claim rewards.

**Q. What happens if there are multiple first-place winners?**  
A. The reward will be divided equally. (e.g., If the reward amount is RM2,500 and there are 2 winners, each will receive RM1,250.)  
